...
/// type resolver mechanism. Enables commands to receive DI-injected services
/// via their constructors, just like ASP.NET controllers.
/// </summary>
...
/// <summary>
/// Resolves command instances from the DI container.
/// </summary>
